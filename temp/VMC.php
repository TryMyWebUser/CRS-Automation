<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-cursor-text="View">
        <a href="images/vmc/1.jpg">
            <figure class="image-anime">
                <img src="images/vmc/1.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="0.2s" data-cursor-text="View">
        <a href="images/vmc/2.jpg">
            <figure class="image-anime">
                <img src="images/vmc/2.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="0.4s" data-cursor-text="View">
        <a href="images/vmc/3.jpg">
            <figure class="image-anime">
                <img src="images/vmc/3.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="0.6s" data-cursor-text="View">
        <a href="images/vmc/4.jpg">
            <figure class="image-anime">
                <img src="images/vmc/4.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="0.8s" data-cursor-text="View">
        <a href="images/vmc/5.jpg">
            <figure class="image-anime">
                <img src="images/vmc/5.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="1s" data-cursor-text="View">
        <a href="images/vmc/6.jpg">
            <figure class="image-anime">
                <img src="images/vmc/6.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="1.2s" data-cursor-text="View">
        <a href="images/vmc/7.jpg">
            <figure class="image-anime">
                <img src="images/vmc/7.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
...
<div class="col-lg-4 col-6">
    ...
    <div class="photo-gallery wow fadeInUp" data-wow-delay="1.4s" data-cursor-text="View">
        <a href="images/vmc/8.jpg">
            <figure class="image-anime">
                <img src="images/vmc/8.jpg" alt="" />
            </figure>
        </a>
    </div>
    <!-- image gallery end -->
